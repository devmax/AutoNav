...
(cl:defmethod cl:initialize-instance :after ((m <filter_state>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'filter_state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AutoNav-msg:<filter_state> is deprecated: use AutoNav-msg:filter_state instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AutoNav-msg:header-val is deprecated.  Use AutoNav-msg:header instead.")
  (header m))
...
(cl:defmethod dx-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AutoNav-msg:dx-val is deprecated.  Use AutoNav-msg:dx instead.")
  (dx m))

(cl:ensure-generic-function 'dy-val :lambda-list '(m))
(cl:defmethod dy-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AutoNav-msg:dy-val is deprecated.  Use AutoNav-msg:dy instead.")
  (dy m))

(cl:ensure-generic-function 'dz-val :lambda-list '(m))
(cl:defmethod dz-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AutoNav-msg:dz-val is deprecated.  Use AutoNav-msg:dz instead.")
  (dz m))
...
(cl:defmethod dyaw-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AutoNav-msg:dyaw-val is deprecated.  Use AutoNav-msg:dyaw instead.")
  (dyaw m))

(cl:ensure-generic-function 'droneState-val :lambda-list '(m))
(cl:defmethod droneState-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AutoNav-msg:droneState-val is deprecated.  Use AutoNav-msg:droneState instead.")
  (droneState m))

(cl:ensure-generic-function 'batteryPercent-val :lambda-list '(m))
(cl:defmethod batteryPercent-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AutoNav-msg:batteryPercent-val is deprecated.  Use AutoNav-msg:batteryPercent instead.")
  (batteryPercent m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<filter_state>)))
  ...
  "f757848d77bf4328f63196ee834021c9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'filter_state)))
  "Returns md5sum for a message object of type 'filter_state"
  "f757848d77bf4328f63196ee834021c9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<filter_state>)))
  ...
  (cl:format cl:nil "# header~%Header      header~%~%# ----------------- raw 10d filter state ----------------------------~%float32     x~%float32     y~%float32     z~%float32     dx~%float32     dy~%float32     dz~%float32     roll~%float32     pitch~%float32     yaw~%float32     dyaw~%~%# ----------------- propagated from drone messages: -----------------~%# 0: Unknown, 1: Init, 2: Landed, 3: Flying, 4: Hovering, 5: Test~%# 6: Taking off, 7: Goto Fix Point, 8: Landing, 9: Looping~%# Note: 3,7 seems to discriminate type of flying (isFly = 3 | 7)~%uint32       droneState~%float32      batteryPercent    # 0 means no battery, 100 means full battery~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'filter_state)))
  "Returns full string definition for message of type 'filter_state"
  (cl:format cl:nil "# header~%Header      header~%~%# ----------------- raw 10d filter state ----------------------------~%float32     x~%float32     y~%float32     z~%float32     dx~%float32     dy~%float32     dz~%float32     roll~%float32     pitch~%float32     yaw~%float32     dyaw~%~%# ----------------- propagated from drone messages: -----------------~%# 0: Unknown, 1: Init, 2: Landed, 3: Flying, 4: Hovering, 5: Test~%# 6: Taking off, 7: Goto Fix Point, 8: Landing, 9: Looping~%# Note: 3,7 seems to discriminate type of flying (isFly = 3 | 7)~%uint32       droneState~%float32      batteryPercent    # 0 means no battery, 100 means full battery~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
